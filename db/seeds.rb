...
# s -> titles, ch -> chapters, cl -> articles

puts "creating titles"

puts "creating title 1"
s1 = Title.create!(number: 1,
description: "El Estado Panameño",
legislation: l)

puts 'creating chapter 0'
ch0 = Chapter.create!(number: 0, description: "Hello from chapter 0", title: s1)

puts "creating clauses for title 1 with questions and metadata"

puts 'creating article 1'
cl1 = Article.create!(content: 'La Nación panameña está organizada en Estado soberano e independiente, cuya denominación es República de Panamá. Su gobierno es unitario, republicano, democrático y representativo.',
  chapter: ch0,
  number: 1)

  Question.create!(content: 'How well does this represent your views?', article: cl1)
  Question.create!(content: 'Does this strengthen Panamanian law system?', article: cl1)
  Question.create!(content: 'Please provide your suggested revision', article: cl1)
...
cl2 = Article.create!(content: 'El Poder Público sólo emana del pueblo. Lo ejerce el Estado conforme esta Constitución lo establece, por medio de los Órganos Legislativo, Ejecutivo y Judicial, los cuales actúan limitada y separadamente, pero en armónica colaboración',
  chapter: ch0,
  number: 2)
  Question.create!(content: 'How well does this represent your views?', article: cl2)
  Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl2)
  Question.create!(content: 'Please provide your suggested revision', article: cl2)
  Metadatum.create!(
...
cl4 = Article.create!(content: 'La República de Panamá acata las normas del Derecho Internacional.',
  chapter: ch0,
  number: 4)
  Question.create!(content: 'How well does this represent your views?', article: cl4)
  Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl4)
  Question.create!(content: 'Please provide your suggested revision', article: cl4)

  # SubArticle.create!(article: cl4, content: 'Build a single digital platform that aligns access to government datasets and to electronically process Freedom of Information (FOI) requests for every MDA;')
  # SubArticle.create!(article: cl4, content: 'Amend the FOI Act to strengthen enforcement and compliance;')
  # SubArticle.create!(article: cl4, content: 'Harmonise e-Governance by using a Whole of Government (WoG) approach to rationalise and simplify access to government services.')
...
cl5 = Article.create!(content: 'El  territorio  del  Estado  panameño  se  divide  políticamente  en Provincias, éstas a su vez en Distritos y los Distritos en Corregimientos. La ley podrá crear otras divisiones políticas, ya sea para sujetarlas a regímenes especiales o por razones de conveniencia administrativa o de servicio público. ',
  chapter: ch0,
  number: 5)
  Question.create!(content: 'How well does this represent your views?', article: cl5)
  Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl5)
  Question.create!(content: 'Please provide your suggested revision', article: cl5)
...
puts 'creating article 6'
  ...
  cl6 = Article.create!(content: 'Los símbolos de la Nación son: el himno, la bandera y el escudo de armas, adoptados por la Ley 34 de 1949. ',
  chapter: ch0,
  number: 6)
  Question.create!(content: 'How well does this represent your views?', article: cl6)
  Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl6)
  Question.create!(content: 'Please provide your suggested revision', article: cl6)
...
puts 'creating article 7'
  ...
  cl7 = Article.create!(content: 'El español es el idioma oficial de la República.',
  chapter: ch0,
  number: 7)
  Question.create!(content: 'How well does this represent your views?', article: cl7)
  Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl7)
  Question.create!(content: 'Please provide your suggested revision', article: cl7)
...
# s2 = title.create!(title: 'Education Reform, Skills Development and R+D',
...
# puts "creating articles for title 2"

# cl6 = Article.create!(title: s2, content: 'Reform the national education system and curricula:')
#   SubArticle.create!(article: cl6,
...
#   Question.create!(content: 'How well does this represent your views?', article: cl8)
#   Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl8)
#   Question.create!(content: 'Please provide your suggested revision', article: cl8)
...
#   Question.create!(content: 'How well does this represent your views?', article: cl9)
#   Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl9)
#   Question.create!(content: 'Please provide your suggested revision', article: cl9)
...
#   Question.create!(content: 'How well does this represent your views?', article: cl10)
#   Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl10)
#   Question.create!(content: 'Please provide your suggested revision', article: cl10)
...
# cl11 = Article.create!(title: s2,
#   content: 'Expand Research and Development by simplifying tax incentives.')
#   Question.create!(content: 'How well does this represent your views?', article: cl11)
#   Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl11)
#   Question.create!(content: 'Please provide your suggested revision', article: cl11)
...
#     status: 'title 26 of  Companies Income Tax Act allows 20% investment tax credit.
...
# s3 = title.create!(title: 'Supporting the Ecosystem for Innovative Entrepreneurship',
# description: "By 2025, Nigeria will become a digital economy and ICT will contribute 25% to the national GDP.",
# legislation: l)

# puts 'article 12'
# cl12 = Article.create!(title: s3,
...
#   SubArticle.create!(article: cl12, content: 'Simplify procedures for opening and closing a business;')
#   SubArticle.create!(article: cl12, content: 'Ease cross-border trade by simplifying procedures and reviewing restrictions on both imports and exports;')
#   SubArticle.create!(article: cl12, content: 'Simplify access to subsidised credit facilities for startups;')
#   SubArticle.create!(article: cl12, content: 'Raise awareness about opportunities for digital entrepreneurship and skills acquisition.')
#   Question.create!(content: 'How well does this represent your views?', article: cl12)
#   Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl12)
#   Question.create!(content: 'Please provide your suggested revision', article: cl12)

#   Metadatum.create!(article: cl12,
...
#   Question.create!(content: 'How well does this represent your views?', article: cl13)
#   Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl13)
#   Question.create!(content: 'Please provide your suggested revision', article: cl13)

#   Metadatum.create!(article: cl13,
...
#   Question.create!(content: 'How well does this represent your views?', article: cl14)
#   Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl14)
#   Question.create!(content: 'Please provide your suggested revision', article: cl14)

#   Metadatum.create!(article: cl14,
...
#   Question.create!(content: 'How well does this represent your views?', article: cl15)
#   Question.create!(content: 'Does this strengthen the Nigerian technology entrepreneurship ecosystem?', article: cl15)
#   Question.create!(content: 'Please provide your suggested revision', article: cl15)
...
# # puts "creating articles for section 1 with questions and metadata"

# # cl1 = Article.create!(content: 'Incentivise telecommunication infrastructure sharing to achieve the economies of scale necessary for universal affordable access. Government will support private sector providers to merge their infrastructure.',
# #   section: s1)
