...
t15 = Title.create!(number: 15,
  ...
  c152 = Chapter.create!(number: 2,
    ...
    a328 = Article.create!(content: 'En lo que no contradiga lo dispuesto en esta Constitución la Autoridad del Canal de Panamá integrará a su organización la estructura administrativa y operacional existente en la Comisión del Canal de Panamá al 31 de diciembre de 1999, incluyendo sus departamentos, oficinas, posiciones, normas vigentes, reglamentos y convenciones colectivas vigentes, hasta que sean modificados de acuerdo a la Ley.  /n
    ...
    puts 'creating article 328'
    a328 = Article.create!(content: "Todos los casos en materia constitucional que se encuentren pendientes en el Pleno de la Corte Suprema de Justicia, se adjudicarán al Tribunal Constitucional, excepto aquellos que ya estén en lectura o con proyectos de fallo.",
      chapter: c152,
      number: 328,
      new: true)
